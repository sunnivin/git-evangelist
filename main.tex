...
\subsection{Clarification of expectations}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{\setframetitle{}}
  % \vspace{-0.2cm}
  \only<1>
...
\subsection{Establish a common mindset}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{\setframetitle{}}
  
  \begin{figure}
    \subcaptionbox{Extreams of community mindsets }
...
\subsection{Choose good enough practices}
...
\begin{frame}{\setframetitle{}}
 ...
 \only<1>
  {
 \begin{figure}
         \subcaptionbox{Unwanted stages of software development \footnote{\fullcite{wilson2017good}}}
